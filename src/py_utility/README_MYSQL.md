...
```python
from app.common.mysql_client import get_mysql_client
...
```python
from app.common.mysql_client import MySQLClient
...
```python
from app.common.mysql_client import init_mysql_client, get_mysql_client
...
# 运行测试
cd trade
./test.sh integration/test_mysql_client.py
```
...
pytest tests/integration/test_mysql_client.py
```
